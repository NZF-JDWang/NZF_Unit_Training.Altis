...
// Step 1b
_selectedRandom = _this select 1; // Gets the second element in the list (list is at index 3), should be an integer
// Step 1c
_offset = _this select 2; // Gets the third element in the list (list is at index 3), should be an integer
// Step 1d
_display = _this select 3; // Gets the fourth element in the list (list is at index 3), should be a boolean
